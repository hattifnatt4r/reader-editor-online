...
<h3> Reading </h3> To play selected text click on the "play" button in the right side of window. Use the same button to pause. 
To move selection click on right and left arrows. <br>
